import { r as registerInstance, h } from './core-6a64acb2.js';
...
const SmartComplete = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.throttle = 600;
        this.limit = 10;
        this.searchresults = { results: [], total: 0 };
        this.dictionaryresults = { analysis: [], dictresults: [], total: 0 };
        this.status = Status.disconnected;
        this.throttled = throttle(this.throttle, false, this.throttledChanged);
        //data: Backend = new Backend('wss://kunwok-service.herokuapp.com/ws')
        this.data = new Backend('ws://localhost:8000/ws');
    }
    handleSubmit(e) {
        e.preventDefault();
    ...
    render() {
        return (h("div", { class: "app" }, h("div", { class: "header" }, h("h3", null, "Plains Cree Word Builder ")), h("br", null), h("div", { class: "text-display" }, h("h2", { id: "word" }, this.currentWord)), h("br", null), h("div", null, h("button", { class: "copyButton", onClick: () => this.copyToClipboard(this.currentWord) }, "Copy Word")), h("div", { class: "body" }, h("div", { class: "row" }, h("div", { class: "column" }, h("div", { class: "searchbox" }, h("form", { onSubmit: (e) => this.handleSubmit(e) }, h("input", { class: "inputbox", type: "text", ref: (el) => this.textInput = el, onKeyUp: () => this.preThrottled() })), h("div", { class: "results" }, this.searchresults.results.map((result) => //result here is a tuple(str, bool), where the str is the form, and the bool tells us if its a complete form
         h("div", { class: "hit", onClick: () => this.onHitClick(result) }, result[2] //todo: put result[2] here: the prefix
        , h("b", null, result[1] && (result[3] + " ✔") || (result[3])))), this.searchresults.total > this.limit ?
            h("div", { class: "hit" }, "+ ", this.searchresults.total - this.limit, " more...") :
            null)))))));
    }
    static get style() { return ".app {\n  font-family: Verdana, Geneva, Tahoma, sans-serif;\n}\n.app .header {\n  text-align: left;\n  background-color: #ca4321;\n  height: 25px;\n  font-size: medium;\n  font: medium;\n  color: white;\n}\n.app .header .logo {\n  -webkit-animation: app-logo-spin infinite 20s linear;\n  animation: app-logo-spin infinite 20s linear;\n  height: 80px;\n  transform-box: fill-box;\n}\n.app .text-display {\n  text-align: center;\n  outline-style: dashed;\n  background-color: #f5f5f5;\n  height: 130px;\n  padding: 50px;\n  font-size: xx-large;\n  color: black;\n}\n.app .copyButton {\n  position: absolute;\n  padding: 5px 20px 5px 20px;\n  left: 15px;\n  top: 251px;\n  font-size: medium;\n  color: black;\n  background-color: #fff8d7;\n}\n.app .body {\n  -ms-flex-direction: column;\n  flex-direction: column;\n  -ms-flex-align: center;\n  align-items: center;\n  width: 100%;\n  margin-top: 0px;\n}\n.app .body .row {\n  display: -ms-flexbox;\n  display: flex;\n  /* Create two equal columns that sits next to each other */\n}\n.app .body .row .column {\n  -ms-flex: 50%;\n  flex: 50%;\n  padding: 10px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-direction: row;\n  flex-direction: row;\n}\n.app .body .row .column .searchbox {\n  position: absolute;\n  padding: 2px 10px 2px 0px;\n}\n.app .body .row .column .searchbox .inputbox {\n  border: 2px solid grey;\n  border-radius: 5px;\n  font-size: large;\n  height: 45px;\n  width: 300px;\n  padding: 2px 10px 2px 10px;\n  outline: 4;\n  background-color: #f5f5f5;\n}\n.app .body .row .column .searchbox .inputButton {\n  position: absolute;\n  padding: 15px 20px 15px 20px;\n  left: 325px;\n  font-size: medium;\n  color: white;\n  background-color: #ca4321;\n}\n.app .body .row .column .results {\n  position: absolute;\n  left: 0px;\n  top: 52px;\n  width: 320px;\n  padding: 2px 10px 2px 2px;\n}\n.app .body .row .column .results .hit {\n  padding-left: 5px;\n  -ms-flex-direction: row;\n  flex-direction: row;\n  -ms-flex-align: center;\n  align-items: center;\n  height: 23px;\n  background-color: #f5f5f5;\n  border: 1px solid black;\n}\n.app .body .row .column .dictresults {\n  position: absolute;\n  padding: 2px 10px 2px 2px;\n  left: 450px;\n}\n.app .body .row .column .dictresults .analysis {\n  position: absolute;\n  white-space: pre-wrap;\n  background-color: #fff8d7;\n  border: 1px solid black;\n  padding: 10px;\n  width: 330px;\n}\n.app .body .row .column .dictresults .dictentry {\n  position: absolute;\n  background-color: #fff8d7;\n  border: 1px solid black;\n  padding: 10px;\n  left: 375px;\n  width: 330px;\n  border: 1px solid black;\n}\n\n\@-webkit-keyframes app-logo-spin {\n  from {\n    -webkit-transform: rotate(0deg);\n    transform: rotate(0deg);\n  }\n  to {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n  }\n}\n\n\@keyframes app-logo-spin {\n  from {\n    -webkit-transform: rotate(0deg);\n    transform: rotate(0deg);\n  }\n  to {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n  }\n}"; }
};

export { SmartComplete as smart_complete };
